...
public final class SeekbarPreferenceLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private SeekbarPreferenceLayoutBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static SeekbarPreferenceLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SeekbarPreferenceLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.seekbar_preference_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SeekbarPreferenceLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SeekbarPreferenceLayoutBinding((LinearLayout) rootView, icon, iconFrame, summary,
          title, widgetFrame);
    }
